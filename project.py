...
for item in elements:
    ...
    #     index = item.get_attribute("style").find("translate(")
    #     index += 10
    #     locations.append(item.get_attribute("style")[index:len(item.get_attribute("style"))-24] + ", " + item.get_attribute("src")[len(item.get_attribute("src"))-6:len(item.get_attribute("src"))-4])
